                ...
                <p class="text-[#DCDCDC] mb-5"
                    ...
                    <span
                        style="background: linear-gradient(90deg, rgba(181,30,23,1) 0%, rgba(252,63,55,1) 100%);
                                 -webkit-text-fill-color: transparent;
                                 -webkit-background-clip: text;
                                 background-clip: text;">reducing
                        staffing times by 5x.</span>
                </p>
          ...
          display: inline-block;"
            ...
            <div class="w-full px-3 my-auto mt-10 lg:w-1/2 text-end lg:mt-0">
                <div style="margin-top: 15px;">
                    {{-- Desktop Image --}}
                    <img src="{{ asset('assets/images/Right-Side-_1_.webp') }}" alt="Dream Team Right Side"
                        class="hidden h-auto max-w-full lg:inline-block">

                    {{-- Mobile Image (fallback to same if no separate mobile image) --}}
                    <img src="{{ asset('assets/images/Frame-1261152964-1-optimized-1.webp') }}" alt="Dream Team Mobile"
