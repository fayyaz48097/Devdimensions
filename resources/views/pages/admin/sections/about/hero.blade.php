...
@section('page-title', 'About Hero Section')
    ...
    <div class="sec-wrap">
        ...
        <div class="sec-header">
            <div>
                ...
                <p>Manage the main hero banner on the About Us page.</p>
            </div>
            @if ($hero && !$hero->trashed())
                <div style="display:flex; gap:10px; flex-wrap:wrap;">
                    {{-- Toggle Status --}}
                    <form action="{{ route('admin.sections.about.hero.toggleStatus', $hero) }}" method="POST">
                        @csrf @method('PATCH')
                        @if ($hero->isActive())
                    ...
                    {{-- Soft Delete --}}
                    <form action="{{ route('admin.sections.about.hero.destroy', $hero) }}" method="POST"
            ...
            <div class="fc">
                <div class="fc-body">
                    <div class="empty-state">
                        ...
                        <form action="{{ route('admin.sections.about.hero.restore', $hero->id) }}" method="POST"
            ...
            <div class="fc" style="margin-bottom:20px;">
                <div class="fc-body">
                    <div class="empty-state" style="padding-bottom:10px;">
                        ...
                        <h3>No About Hero Content Yet</h3>
                        <p>Fill in the form below to create the Hero Section for the About page.</p>
                    </div>
                </div>
            </div>

            @include('pages.admin.sections.about._about-hero-form', ['hero' => null, 'isNew' => true])
        ...
        @else
            ...
            @include('pages.admin.sections.about._about-hero-form', ['hero' => $hero, 'isNew' => false])
        @endif
